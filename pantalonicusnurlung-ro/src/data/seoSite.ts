...
export function productSchema(
  ...
  image = `${SITE}/images/seo-products/pantaloni-cu-snur-lung-negri-produs-unisex.webp`,
) {
  return {
    '@context': 'https://schema.org',
    '@type': 'Product',
...
const baseSections = [
  ...
  ['Entitati si contexte relevante', 'Ghidul foloseste entitati semantice naturale: moda urbana, oversized fashion, urban wear, minimal fashion, cargo pants, sneakers, monochrome outfits, siret lung, snur lung, layering, Japanese moda urbana si outfituri ton pe ton. Aceste conexiuni ajuta Google, AI Overviews, ChatGPT Search si Perplexity sa inteleaga ca site-ul nu targeteaza doar un cuvant, ci intreaga zona de intentii din jurul croielilor relaxate.'],
...
const landingPages = [
  page('pantaloni-cu-siret-lung', 'Pantaloni cu siret lung | Ghid vizual urban', 'Ghid SEO despre pantaloni cu siret lung: ce inseamna, cum se diferentiaza de snur lung, modele negre, scurte si outfituri urbane.', 'Pantaloni cu siret lung', 'Pantalonii cu siret lung sunt cautati de multi utilizatori pentru acelasi detaliu vizibil numit corect snur lung: capetele albe sau contrastante lasate in fata, care regleaza talia si dau tinutei un accent urban clar.', [
    ...
    ['De ce este un detaliu puternic in Google Images', 'Siretul lung creeaza contrast vertical pe pantaloni negri, bleumarin, maro sau gri. In cautari vizuale, acest detaliu se vede imediat si ajuta utilizatorul sa diferentieze modelul fata de joggeri simpli sau pantaloni de trening clasici.'],
  ...
  page('pantaloni-negri-cu-siret-lung', 'Pantaloni negri cu siret lung | Outfituri si poze', 'Pantaloni negri cu siret lung pentru tinute urbane: imagini, styling cu tricou alb, croieli baggy si variante unisex.', 'Pantaloni negri cu siret lung', 'Pantalonii negri cu siret lung sunt cei mai usor de recunoscut in imagini: materialul inchis scoate in evidenta siretul alb, iar croiala larga duce rapid tinuta in zona moda urbana.', [
    ...
    ['Ce imagini functioneaza', 'Fotografiile frontale de produs arata cel mai bine siretul lung, iar pozele cu model masculin sau feminin explica proportia reala. Pentru Google Images, alt textul trebuie sa includa culoarea, siretul lung si croiala, fara repetitii inutile.'],
  ...
  page('pantaloni-scurti-cu-siret-lung', 'Pantaloni scurti cu siret lung | Vara si streetwear', 'Ghid despre pantaloni scurti cu siret lung: modele negre, gri, bumbac, fermoare, tricou alb si outfituri de vara.', 'Pantaloni scurti cu siret lung', 'Pantalonii scurti cu siret lung duc acelasi accent urban intr-o forma de vara: talie elastica, capete vizibile in fata si croiala lejera pentru miscare.', [
    ...
    ['Negru, gri sau fermoare', 'Modelele negre sunt cele mai versatile, iar cele gri cu fermoare atrag atentia in Google Images prin contrastul dintre material, siret si detaliile frontale. Fermoarele adauga directie vizuala fara imprimeuri mari.'],
  ...
  page('pantaloni-cu-siret-lung-barbati', 'Pantaloni cu siret lung barbati | Ghid marimi si fit', 'Pantaloni cu siret lung barbati: cum alegi fitul, croiala, lungimea, outfitul cu tricou alb si modelele negre baggy.', 'Pantaloni cu siret lung barbati', 'Pentru barbati, pantalonii cu siret lung functioneaza cel mai bine in croieli largi, baggy sau loose fit, unde talia elastica ramane comoda si detaliul frontal se vede clar.', [
    ...
    ['De ce negrul indexeaza bine vizual', 'Pe pantaloni negri, siretul alb lung se vede cel mai bine. Aceasta combinatie este usor de citit in miniaturile din Google Images, ceea ce poate ajuta la click atunci cand imaginea este clara si numele fisierului este descriptiv.'],
  ...
  page('tricou-gri-pantaloni-albi-siret-lung', 'Tricou gri cu pantaloni albi cu siret lung', 'Outfit unisex cu tricou gri oversized si pantaloni scurti albi cu siret lung: contrast soft, tinuta de vara si styling urban curat.', 'Tricou gri cu pantaloni albi cu siret lung', 'Tricoul gri oversized si pantalonii scurti albi cu siret lung creeaza o tinuta de vara luminoasa, unisex si usor de citit in imagini: sus neutru, jos curat, cu siretul alb vizibil ca detaliu central.', [
    ...
    ['Cum folosim imaginea pentru SEO', 'Numele fisierului, alt textul si titlul trebuie sa descrie exact ce se vede: tricou gri, pantaloni scurti albi, siret lung si tinuta unisex. Aceasta precizie ajuta Google Images mai mult decat repetarea fortata a aceluiasi keyword.'],
  ...
  page('set-alb-pantaloni-scurti-siret-lung', 'Set alb cu pantaloni scurti cu siret lung', 'Outfit all white cu tricou alb oversized, pantaloni scurti albi cu siret lung si sneakers albi pentru tinute unisex de vara.', 'Set alb cu pantaloni scurti cu siret lung', 'Setul alb cu tricou oversized si pantaloni scurti cu siret lung este o tinuta de vara foarte curata vizual: aceeasi culoare sus-jos, volum relaxat si siretul lasat in fata ca detaliu central.', [
    ['Intentia SEO', 'Pagina raspunde cautarilor de outfit all white, pantaloni scurti albi cu siret lung si set alb casual. Nu concureaza pagina generala de pantaloni cu siret lung, ci arata o combinatie concreta pentru vara.'],
    ['De ce merge all white', 'Tinuta alba arata curat in poze, se vede bine in Google Images si scoate in evidenta forma pantalonilor prin umbre, tiv si caderea siretului. Pentru utilizator, imaginea transmite rapid confort si simplitate.'],
  ...
  page('tricou-bej-pantaloni-albi-siret-lung', 'Tricou bej cu pantaloni albi cu siret lung', 'Tinuta soft cu tricou bej oversized si pantaloni scurti albi cu siret lung: paleta neutra, vara, stil urban minimalist.', 'Tricou bej cu pantaloni albi cu siret lung', 'Tricoul bej oversized si pantalonii scurti albi cu siret lung creeaza o tinuta neutra, calda si usor de purtat vara. Este o varianta mai soft decat contrastul alb-negru, dar pastreaza detaliul siretului vizibil.', [
    ...
    ['SEO pentru imagini', 'Alt textul descrie exact tinuta: tricou bej, pantaloni scurti albi, siret lung si context unisex. Aceasta precizie ajuta mai mult decat repetarea excesiva a expresiei pantaloni cu siret lung.'],
  ...
  page('tricou-verde-armata-pantaloni-albi-siret-lung', 'Tricou verde armata cu pantaloni albi cu siret lung', 'Outfit unisex cu tricou verde armata oversized si pantaloni scurti albi cu siret lung, pentru vara si stil urban minimalist.', 'Tricou verde armata cu pantaloni albi cu siret lung', 'Tricoul verde armata oversized si pantalonii scurti albi cu siret lung creeaza un contrast urban curat: culoare inchisa sus, alb luminos jos si siret vizibil in fata.', [
    ...
    ['SEO pentru imagini', 'Imaginea trebuie descrisa concret: tricou verde armata, pantaloni scurti albi, siret lung, tinuta unisex. Aceasta descriere ajuta cautarile vizuale fara keyword stuffing.'],
  ...
  page('tricou-bleumarin-pantaloni-albi-siret-lung', 'Tricou bleumarin cu pantaloni albi cu siret lung', 'Tinuta cu tricou bleumarin oversized si pantaloni scurti albi cu siret lung: contrast navy-alb, unisex, casual urban.', 'Tricou bleumarin cu pantaloni albi cu siret lung', 'Tricoul bleumarin oversized si pantalonii scurti albi cu siret lung formeaza o tinuta navy-alb foarte clara in imagini, potrivita pentru vara si pentru outfituri unisex simple.', [
    ...
    ['Pentru Google Images', 'Fotografia cu model purtand tinuta completa este mai utila decat o poza de produs izolata, pentru ca arata proportia dintre tricou oversized, pantaloni scurti si siretul lung.'],
  ...
  page('tricou-tie-dye-pantaloni-albi-siret-lung', 'Tricou tie dye cu pantaloni albi cu siret lung', 'Outfit unisex cu tricou tie dye gri-albastru si pantaloni scurti albi cu siret lung: tinuta statement, vara si stil urban.', 'Tricou tie dye cu pantaloni albi cu siret lung', 'Tricoul tie dye gri-albastru si pantalonii scurti albi cu siret lung creeaza o tinuta statement: partea de sus atrage privirea, iar pantalonii albi pastreaza outfitul curat si lasa siretul vizibil in fata.', [
    ...
    ['Pentru Google Images', 'Imaginea completă cu model este potrivita pentru cautari vizuale: arata proportia tricoului tie dye, lungimea pantalonilor scurti si pozitia siretului. Alt textul descrie concret piesele si culorile.'],
...
export const blogPosts = [
  page('blog/siret-lung-vs-snur-lung', 'Siret lung vs snur lung la pantaloni', 'Explicatie clara intre siret lung si snur lung la pantaloni, cu exemple de cautari, imagini si recomandari SEO pentru utilizatori.', 'Siret lung vs snur lung la pantaloni', 'Siret lung si snur lung sunt folosite des pentru acelasi detaliu vizibil la talia pantalonilor. Snur lung este termenul mai corect, iar siret lung este varianta populara pe care multi utilizatori o tasteaza dupa ce vad poza.', [
    ['Diferenta de termen', 'Snurul este cordonul textil folosit la talia pantalonilor. Siretul este termenul asociat incaltamintei, dar in cautari oamenii il folosesc pentru orice cordon lung si vizibil. Pentru SEO, merita acoperite ambele formulari fara sa le pui pe aceeasi intentie comerciala agresiva.'],
